    ...
    <header id="clientes-header">
        <div class="container">
            <div class="d-none d-sm-block text-right mb-3">
                <h3 class="display-3"><span class="textoFondoTitulo">Clientes</span></h3>
                <p class="lead d-none d-md-block"><span class="textoFondo">Nuestros clientes son nuestra mejor tarjeta de presentación.</span></p>
            </div>
        </div>
    </header>
    ...
    <section id="clientes" class="my-3  text-center">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3 class="display-4 text-left text-muted">Ya confían en nosotros:</h3>
                </div>
            </div>
        </div>
