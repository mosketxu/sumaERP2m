                    ...
                    <form method="post" action="{{ route('user.update',$user->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group input-group-sm mb-3 col-sm-6">
                                ...
                                <input type="text" class="form-control" name="userlastname" value="{{ old('userlastname',$user->lastname) }}" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-group input-group-sm mb-3 col-sm-6">
                                ...
                                <input type="email" class="form-control" name="useremail" value="{{ old('useremail',$user->email) }}" />
                            </div>
                            <div class="input-group input-group-sm mb-3 col-sm-6">
                                <div class="input-group-prepend">
